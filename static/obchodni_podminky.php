...
<head>
    <meta charset="utf-8" />
    <title>Kateřina Beránková - Obchodní podmínky</title>
...
<h2 style="text-align: left; margin-left: 2.5em;">I. Úvodní ustanovení</h2>

<ol type="1" start="1">
    <li>Tyto všeobecné obchodní podmínky (dále jen "obchodní podmínky") jsou vydané dle § 1751 a násl. zákona č. 89/2012 Sb., občanský zákoník (dále jen "občanský zákoník")<br>
    <ul>
        <li>Bc. Kateřina Beránková</li>
        <li>adresa: Korunní 1279/64
            12000, Praha 2</li>
        <li>email: katka.berankova1@gmail.com</li>
        <li>telefon: +420 604 527 870</li>
        <li>www.berankova-obrazy.cz</li>
    </ul><strong>(dále jen "prodávající")</strong></li>
    <br>
    <li>Tyto obchodní podmínky upravují vzájemná práva a povinnosti prodávajícího a fyzické osoby, která uzavírá kupní smlouvu mimo svoji podnikatelskou činnost jako spotřebitel, nebo v rámci své podnikatelské činnosti (dále jen: "kupující") prostřednictvím webového rozhraní umístěného na webové stránce dostupné na internetové adrese www.keramika-dum.cz (dále je "internetový obchod").</li>
...
<h2 style="text-align: left; margin-left: 2.5em;">II. Informace o zboží a cenách</h2>

<ol type="1" start="1">
    <li>
        Informace o zboží, včetně uvedení ceny zboží a jeho hlavních vlastností jsou předmětem dohody mezi kupujícím a prodávajícím a uvedeny v jejich vzájemné komunikace. Ceny zboží jsou uvedeny včetně daně z přidané hodnoty, všech souvisejících poplatků a nákladů za vrácení zboží, jestliže toto zboží ze své podstaty nemůže být vráceno obvyklou poštovní cestou. Ceny zboží zůstávají v platnosti po dobu, po kterou jsou zobrazovány v internetovém obchodě. Toto ustanovení nevylučuje sjednání kupní smlouvy za individuálně sjednaných podmínek.
    </li>
    <li>V internetovém obchodě jsou zveřejněny informace o nákladech spojených s balením a dodáním zboží. Informace o nákladech spojených s balením a dodáním zboží uvedené v internetovém obchodě platí pouze v případech, kdy je zboží doručováno v rámci území České republiky a na Slovensko.</li>
    <li>Případné slevy z kupní ceny zboží nelze navzájem kombinovat, nedohodne-li se prodávající s kupujícím jinak.</li>
</ol>

<h2 style="text-align: left; margin-left: 2.5em;">III. Objednávka a uzavření kupní smlouvy</h2>
...
<h2 style="text-align: left; margin-left: 2.5em;">IV. Zákaznický účet</h2>
...
<h2 style="text-align: left; margin-left: 2.5em;">V. Platební podmínky a dodání zboží</h2>
...
<ol type="1" start="1">
    ...
    <li>Společně s kupní cenou je kupující povinen uhradit prodávajícímu náklady spojené s balením a dodáním zboží ve smluvené výši. Není-li dále uvedeno výslovně jinak, rozumí se dále kupní cenou i náklady spojené s dodáním zboží.<ul>
    ...
    <li>V případě bezhotovostní platby je kupující povinen uhrazovat kupní cenu zboží společně s uvedením variabilního symbolu platby. V případě bezhotovostní platby je závazek kupujícího uhradit kupní cenu splněn okamžikem připsání příslušné částky na bankovní účet prodávajícího.</li>
    <li>Zálohu na kupní cenu může prodávající požadovat především u objednávek s celkovou cenou nad 1.000 Kč.</li>
    <li>Dále je prodávající oprávněn požádat kupujícího o uhrazení celé ceny zboží před jeho odesláním nebo předáním (§ 2119 odst. 1 občanského zákoníku se nepoužije).

        Zboží je kupujícímu dodáno:
        <ul>
            <li>na adresu určenou kupujícím objednávce,</li>
            <li>osobním odběrem v dílně prodávajícího, v termínu předem dohodnutém telefonicky či e-mailem.</li>
        </ul></li>
...
<li>Prodávající vystaví kupujícímu daňový doklad - fakturu. Při platbě předem na účet prodávajícího je daňový doklad odeslán na emailovou adresu kupujícího. V případě platby zboží na dobírku je daňový doklad přiložen k dodávanému zboží.</li>
...
<h2 style="text-align: left; margin-left: 2.5em;">VI. Odstoupení od smlouvy</h2>
...
<ol type="1" start="1">
    ...
    <li>Vrácené zboží nesmí být prodávajícímu zasláno na dobírku. Zásilka se zbožím musí být pojištěna a označena jako Křehké (umožňuje-li takové označení dopravce). Zboží zaslané na dobírku není prodávající povinen převzít. Ke vrácenému zboží je doporučeno přiložit: kopii dodacího listu a faktury, pokud tyto dokumenty byly vystaveny, nebo jiný doklad prokazující koupi zboží; písemné vyjádření o odstoupení od smlouvy (na reklamačním formuláři prodávajícího nebo jinak) a zvoleném způsobu vrácení peněz (převod na účet, osobní převzetí hotovosti nebo poštovní poukázka či jinak). Nepředložení některého z výše uvedených dokladů nebrání kladnému vyřízení Vašeho odstoupení od smlouvy dle zákonných podmínek.</li>
    <li>Odstoupí-li kupující od smlouvy, vrátí mu prodávající bezodkladně, nejpozději však do 14 dnů od odstoupení od smlouvy, všechny peněžní prostředky. Prodávající vrátí kupujícímu přijaté peněžní prostředky jiným způsobem jen tehdy, pokud s tím kupující souhlasí a pokud mu tím nevzniknou další náklady. </li>
    ...
    <li>Prodávající je oprávněn odstoupit od kupní smlouvy v případě, že zboží již není možné za původních podmínek vyrobit či dodat, plnění se stane objektivně nemožným nebo protiprávním. Prodávající bezodkladně informuje kupujícího prostřednictví emailové adresy uvedené v objednávce a vrátí ve lhůtě 14 dnů od oznámení o odstoupení od kupní smlouvy všechny peněžní prostředky včetně nákladů na dodání, které od něho na základě smlouvy přijal, a to stejným způsobem, popřípadě způsobem určeným kupujícím. </li>
</ol>

<h2 style="text-align: left; margin-left: 2.5em;">VII. Práva z vadného plnění</h2>

<ol type="1" start="1">
    <li>
        Všechny výrobky prodávajícího jsou výsledkem výhradně ruční práce, a proto jsou vždy jedinečnými originály. Z povahy této ruční výroby proto nemohou být dva kusy naprosto stejné. Tyto malé rozdíly mezi jednotlivými kusy od jednoho druhu a vzoru proto nemohou být předmětem reklamace.
    </li>
    <li>
        Prodávající odpovídá kupujícímu, že zboží při převzetí nemá vady. Zejména prodávající odpovídá kupujícímu, že v době, kdy kupující zboží převzal:
        <ul>
            <li>má zboží vlastnosti, které si strany ujednaly, a chybí-li ujednání, má takové vlastnosti, které prodávající nebo výrobce popsal,</li>
    ...
    <li>Délka záruční doby: Záruční doba začíná běžet ode dne předání zboží Kupujícímu. Záruční doba na většinu prodávaných výrobků je poskytována 24 měsíců. U druhů zboží, kde výrobce nabízí prodlouženou záruční dobu, je tato informace uvedena Prodávajícím na záručním listě nebo faktuře.</li>
    <li>Způsob při uplatňování reklamace<br>
        Reklamace se uplatňuje jednostranným právním úkonem, kterým Kupující vytkne konkrétní vadu, sepíše, jak se vada projevuje a sdělí, jaký konkrétní nárok z odpovědnosti za vadu uplatňuje. Toto provede písemně a e-mailem doručí Prodávajícímu.
        <ul>
            <li>Dokumentace vady ve formě přiložené fotografie může zjednodušit celý proces reklamace. V žádném případě bez předchozího písemného oznámení reklamace neposílejte zboží na adresu Prodávajícího. Prodávající neprodleně poté kontaktuje Kupujícího a dohodne s ním nejvhodnější formu reklamační procedury.</li>
            <li>K reklamaci je ve všech případech nutné předložit reklamační protokol, kopii dokladu o koupi v našem obchodě - fakturu (neposílejte originál faktury), kompletní výrobek. V případě že Prodávající nebude schopen zrealizovat reklamaci do 30 dnů ode dne uplatnění reklamace, přiznávají se Kupujícímu stejná práva, jako by se jednalo o neodstranitelnou vadu.</li>
        </ul>
    </li>
    <li>V případě, kdy má zboží prokazatelně neodstranitelnou vadu, která zcela znemožňuje užití zboží, má Kupující nárok na výměnu zboží stejné nebo obdobné jakosti, kvality a druhu.</li>
    ...
    <li>Neoprávněná reklamace, zánik nároku na reklamaci: <br>
        Nárok na reklamaci zaniká při používání zboží v podmínkách, které neodpovídají podmínkám uvedených v dokumentaci (mezi dokumentaci se počítají i upozornění na originálním obalu k výrobku) ke zboží, nešetrným, nadměrným či neodborným zacházením, zásahem vyšší moci.</li>
    <li>Kontakt pro reklamaci
...
<h2 style="text-align: left; margin-left: 2.5em;">VIII. Doručování</h2>
...
<h2 style="text-align: left; margin-left: 2.5em;">IX. Mimosoudní řešení sporů</h2>
...
<h2 style="text-align: left; margin-left: 2.5em;">X. Závěrečná ustanovení</h2>
...
<p style="color:white; font-size: 20px; margin-left: 5em; margin-top: 15px;">Tyto podmínky nabývají účinnosti dnem 22.3.2024.</p>
